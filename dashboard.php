...
<html>
  ...
  <body onload="">
    <div
      class="desactivarC"
      style="height: 100%;width: 100%;position: fixed;top: 0;left: 0; z-index: 999999;display:none;"
    >
      <img
    ...
    <script>
      $(document).ready(function() {
        if (localStorage.pagina) {
          loadpag(
            localStorage.pagina,
            localStorage.idpagina,
            localStorage.codsuppag
          );
      ...
      function cantSolicitudesxArea() {
        $.ajax({
          url: "developer/Lopersa/cantSolicitudesxArea",
          type: "POST",
          dataType: "JSON",
